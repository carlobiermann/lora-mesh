...
/*
All Nodes are sending random GPS payloads at 1 minute intervals (with 
random variations betweend 0 and 19 milliseconds). No Routing Status 
Broadcasts will be sent for this test-network, as all Routing Statuses 
are hardcoded.
...
void loop(){
  int result = ldm_listener(LoRa.parsePacket(), parentMode);
